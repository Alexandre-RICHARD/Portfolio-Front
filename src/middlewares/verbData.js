export const data = {
    ...
    dateTest: [
        {title: "Mercredi 21 décembre", number: 1, testLength:6 , date: new Date("12/21/22")},
        {title: "Jeudi 22 décembre", number: 2, testLength:12 , date: new Date("12/22/22")},
        {title: "Vendredi 23 décembre", number: 3, testLength:15 , date: new Date("12/23/22")},
        {title: "Samedi 24 décembre", number: 4, testLength:18 , date: new Date("12/24/22")},
        {title: "Dimanche 25 décembre", number: 5, testLength:20 , date: new Date("12/25/22")},
        {title: "Lundi 26 décembre", number: 6, testLength:21 , date: new Date("12/26/22")},
        {title: "Mardi 27 décembre", number: 7, testLength:22 , date: new Date("12/27/22")},
        {title: "Mercredi 28 décembre", number: 8, testLength:23 , date: new Date("12/28/22")},
        {title: "Jeudi 29 décembre", number: 9, testLength:24 , date: new Date("12/29/22")},
        {title: "Vendredi 30 décembre", number: 10, testLength:25 , date: new Date("12/30/22")},
        {title: "Samedi 31 décembre", number: 11, testLength:25 , date: new Date("12/31/22")},
    ],
};