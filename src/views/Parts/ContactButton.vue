...
<template>
    <div class="one-contact-box">
        <a v-if="type === 'link'" :href="copyid" target="_blank" class="contact-element">
            <span class="contact-title">{{ title }}</span>
            <span class="contact-content link">{{ content }}</span>
        </a>


        <button v-if="type === 'copy'" class="contact-element" @click="copy(content, copyid)">
            <span class="contact-title">
                <img v-if="section === 'games'" class="launcher-logo" :src="require(`../../images/laucherLogo/${copyid}.png`)" alt="logo représentant le launcher cité">
                {{ title }}
            </span>
            ...
            <div class="copy-icon">
                <svg
                    ...
                    stroke="currentColor" className="copy-icon"
                >
